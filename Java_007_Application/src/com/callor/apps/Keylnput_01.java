...
/*
 * 실제 App을 사용하여 업무를 수행할떄는
 * 데이터(값)을 키보드로 입력을 하고
 * 입력된 데이터를 변수(배열)에 저장을 하고 
 * 변수에 저장된 데이터를 연산 수행하는 크다가 대부분
 */

public class Keylnput_01 {
