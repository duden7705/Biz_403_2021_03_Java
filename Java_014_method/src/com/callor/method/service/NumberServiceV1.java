...
public class NumberServiceV1 {
	 ...
	 *  		객체.addNum(100,200)
	 *  두 개의 정수를 전달 받기위해서는 method가 준비를 해야 한다
	 *  		method의 ()안에 변수를 선언한다
	 *  		두개의 변수를 선언하자
	 *  
	 *  두수의 합을 계산하여
