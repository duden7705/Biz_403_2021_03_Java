...
public class ScoreVO {
	 ...
	 * 이제 vo객체.toStrin() method를 호출하면
	 * vo 객체의 변수들에 담긴 값들이 출력될 것이다
	 */
	@Override
	public String toString() { // 알트 시프트 에스 투스트링
